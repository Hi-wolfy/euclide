    ...
    <AwesomeSlider animation="cubeAnimation" organicArrows={false}>
      ...
      <div>
        <p>
          ...
          어딘가의 세계에서는 분명 상상 속에서만 존재할 겁니다.
        </p>
      </div>
      <div>
        <p>
          거대한 차원은 수많은 세계의 알갱이들이 거미줄처럼 얽혀 존재하고
          있습니다. 다르게 말하면, 모든 세계는 완전히 분리된 것이 아니라 크고
          작은 영향을 주고받는, 이어진 관계라고도 볼 수 있죠.
          <br /> <br />
      ...
      <div>
        <p>
          ...
          세계가 지속될 수도 있을 겁니다. <br />
          <br />
          끝없는 전쟁으로 인해 스스로 파멸하는 세계, 전염병이 창궐하여 사랑하는
          모든 것을 잃은 세계, 진리를 추구해 무수한 연구를 시도했지만,
          안타깝게도 결국 남은 건 끝없는 허무 뿐이라는 것을 자각하고 발전을
          포기한 세계의 기록도 존재하지요. <br /> <br />
        </p>
      </div>
      ...
      <div>
        <p>
          - 당신은 정말로 세계에서 특별한 재능을 가지고 있는 상태일 수도 있고,
          아닐 수도 있습니다. 그러나 기본적으로 모든 캐릭터들은 호텔 관리인의
          초대를 수락해서 호텔에 들어오게 되었다는 설정입니다. 캐릭터를 회유하기
          위해 적혀있을 문구는 다양합니다. (ex. 캐릭터가 지금껏 가지지 못했던
          것, 이루지 못했던 것 등을 도와주겠다 등)
          <br /> <br /> 자유롭게 설정해주시고, 가급적 신청서 양식에도 적어주시는
          것을 추천합니다. (그러나 이는 필수가 아닙니다.)
        </p>
      </div>
      <div>
        <p>
          ...
          적합한 설정은 가지고 있지 않아도 됩니다.
          <br /> <br /> 본 커뮤니티는 인트로 때에 호텔 관리인이 모두를 모아
          재능을 부여한다는 느낌으로 연출을 진행할 예정입니다.
        </p>
      </div>
      <div>
        <p>
          아래의 예시들은 모두 가능한 설정입니다. <br /> <br />
          <span className="small">
            (Ex1. A 세계에서는 재능인이라는 개념 자체가 없다. 그러나 그 세계의 B
            캐릭터는 싸움을 굉장히 잘했고, 호텔의 초대장을 받아 오게 됐다.
            마스코트는 B 캐릭터에게 세계의 스트리트파이터 라는 칭호를
            부여해주었다.)
            <br /> (Ex2. B 세계 역시 재능인이라는 개념이 존재하지 않는다. 이
            세계의 C 캐릭터는 딱히 특출난 건 없지만 왠지 호텔의 초대장을 받았고,
            마스코트는 운 좋은 C 캐릭터에게 세계의 행운 이라는 칭호를
            부여해주었다.) <br />
      ...
      <div>
        <p>
          ...
          질문해주세요. <br />
          <br />- 세계는 넓고 다양한 종족이 존재합니다. 그러니 얼마든지 다양한
          설정이 부여될 수 있습니다만, 메타적인 벨런스를 지키기 위해 과도한
          먼치킨에 해당하는 설정은 지양을 부탁드립니다. 이에 관련해서도 편히
          질문을 부탁드리겠습니다. <br />
          <br />
          <span className="small">
          ...
          <br />
          <br />
          <img src="img/frame-5.png" width="150px" />
        </p>
      </div>
    </AwesomeSlider>
  );
