    ...
    <AwesomeSlider animation="cubeAnimation" organicArrows={false}>
      ...
      <div>
        <p>
          ...
          <br /> <br /> 그 환경은
          저마다 다를 것이고, 당신이 가지고 있는 모습도 어딘가의 세계에서는 분명
          상상 속에서만 존재할 겁니다. 거대한 차원은 수많은 세계의 알갱이들이
          거미줄처럼 얽혀 존재하고 있습니다. 다르게 말하면, 모든 세계는 완전히
          분리된 것이 아니라 크고 작은 영향을 주고받는, 이어진 관계라고도 볼 수
          있죠.
          <br /> <br />
