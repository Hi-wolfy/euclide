    ...
    <div className="noticeWrap">
      ...
      <div className="noticePaper">
        <p className="notice-content">
          ...
          <br />
          <br />
          - 유클리드 호텔에서는 마스코트가 토의 주제로 준비한 쪽지를 직접
          논파하는 재판 방식을 차용하고 있습니다. 말탄환은 기본적으로 재판당 4개
          존재하며, 주제에 대한 답변을 제시해주시면 됩니다.
          <br />
          <br />
          ...
          <br />
          <br />
          - 재판을 통해 블랙을 추려내는데 성공했을 경우, 블랙은 변론을
          진행합니다.
          <br />
          <br />
          ...
          <br />
          <br />
          - 재판의 보다 자세한 사항은 홈페이지 메인의 조사&재판 가이드를
          참고해주세요.
          <br />
          <br />
          ...
          <br />
          <br />
          - 한 캐릭터에게 좋아하는 물건 3개를 선물할 시, 마스코트로 부터 특별한
